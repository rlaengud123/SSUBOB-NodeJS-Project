...
CREATE TABLE `menu_option_category` (
  ...
  KEY `menu_id` (`menu_id`),
  CONSTRAINT `menu_option_category_ibfk_1` FOREIGN KEY (`menu_id`) REFERENCES `menu` (`menu_id`) ON UPDATE CASCADE
...
INSERT INTO `menu_option_category` VALUES (1,'맵기',1);
...
-- Dump completed on 2019-08-14 22:55:32
