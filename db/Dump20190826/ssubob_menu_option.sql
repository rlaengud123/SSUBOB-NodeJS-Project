...
CREATE TABLE `menu_option` (
  ...
  CONSTRAINT `menu_option_ibfk_2` FOREIGN KEY (`option_category_id`) REFERENCES `menu_option_category` (`option_category_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `menu_option` VALUES (1,'1단계',0,0,1,1),(2,'돼지고기',0,0,2,2),(3,'소고기',500,0,2,2),(4,'닭고기',0,0,2,2),(5,'믹스(돼지+닭)',0,0,2,2),(6,'콜라',0,0,2,3),(7,'사이다',0,0,2,3),(8,'소세지',1000,1,2,4),(9,'치즈',1000,1,2,4),(10,'1단계',0,0,8,5),(12,'1단계',0,0,9,7),(15,'콜라',0,0,9,8),(16,'사이다',0,0,9,8),(17,'1단계',0,0,10,9),(18,'콜라',0,0,10,10),(19,'사이다',0,0,10,10);
...
-- Dump completed on 2019-08-26 21:31:00
